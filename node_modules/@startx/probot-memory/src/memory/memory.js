...
class Memory {
    ...
    createAccount(accountType, identifier, protocol, data, organizationIdentifier) {
        return new Promise((resolve, reject) => {
            var applicationType = (['ASANA'].indexOf(accountType) > -1 ? 'CRM' : ['ZENDESK'].indexOf(accountType) > -1 ? 'HELPDESK' : ['DRIVE'].indexOf(accountType) > -1 ? 'STORAGE' : ['GMAIL'].indexOf(accountType) > -1 ? 'EMAIL' : null);
